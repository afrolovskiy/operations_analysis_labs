...
public class ObtainMatrix 
{
    ...
    public Matrix getMatrix(String inputStr) throws Exception
    {
    ...
    private Matrix parseStringForGetMatrix(String inputStr)
    {
        try{
    ...
    private void initializationMatrix(String inputStr)
    {
        ...
        matrix = new Matrix(degreeOfMatrix);
        curColumnIndex = 0;
        curRowIndex = 0;
    }
